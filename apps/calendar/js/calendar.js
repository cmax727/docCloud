...
Calendar={
	UI:{
		...
		showadvancedoptions:function(){
            st = $("#advanced_options_button").attr("state");
            if ( st != "A"){
			    $("#advanced_options").slideDown('slow');
			    $("#advanced_options_button").attr("state", "A");
                //$("#advanced_options_button").css("display", "none");
            }else{
                $("#advanced_options").slideUp();
                $("#advanced_options_button").attr("state", "B");
            }
		},
		...
		getEventPopupText:function(event){
			...
			//if (event.description){
				html += '<div class="description">' + event.description + '(' + event.location+' )</div>';
			//}
			return html;
		},
		lockTime:function(){
