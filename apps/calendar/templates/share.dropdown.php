...
<select style="width:150px"  id="share_user" title="<?php echo $l->t('select users');?>" data-placeholder="<?php echo $l->t('select users'); ?>">
<option value=""></option>
<?php
...
<select style="width:150px" id="share_group" title="<?php echo $l->t('select groups');?>" data-placeholder="<?php echo $l->t('select groups'); ?>">
<option value=""></option> 
<?php
...
<?php foreach($groups as $group): ?>
	...
	<script>
        ...
        $('#share_user_chzn, #share_group_chzn').css('width', '250px');
