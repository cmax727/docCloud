...
?>
<style>
div.gallery_div {position:relative; display: inline-block; height: 152px; width: 150px; margin: 5px;overflow: hidden;border: 2px solid black;}
.gallery_div div.gallery_div:hover {border: 2px solid aqua;}
...
div.gallery_div img{position:absolute; top: 1; left: 0; -moz-transition-duration: 0.3s; -o-transition-duration:0.3s; -webkit-transition-duration: 0.3s; /*height:150px; width: auto;*/height: 150px; width: 150px;}
