...
<form action="index.php" method="post" class="logo-form">
	<fieldset>
		...
		<input type="checkbox" name="remember_login" value="1" id="remember_login" /><label for="remember_login"><?php echo $l->t('Remember me'); ?></label>
