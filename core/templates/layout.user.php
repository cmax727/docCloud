...
<html>
	<head>
		<title><?php echo isset($_['application']) && !empty($_['application'])?$_['application'].' | ':'' ?>SafeDoc <?php echo OC_User::getUser()?' ('.OC_User::getUser().') ':'' ?></title>
	...
	<body id="<?php echo $_['bodyid'];?>">
		<header><div id="header">
			<a href="<?php echo link_to('', 'index.php'); ?>" title="" id="owncloud"><img class="svg" src="<?php echo image_path('', 'safedoc_logo-wide.png'); ?>" alt="ownCloud" /></a>
		...
		<nav><div id="navigation">
			<ul id="apps" class="svg">
				...
				<?php endforeach; ?>
				<li><a style="background-image:url(/settings/img/users.svg)" href="/settings/users.php" title="" >Users</a></li>
			</ul>
			...
			<ul id="settings" class="svg">
				...
				<span style="margin-left:70px; "><?php echo $l->t('Settings');?></span>
