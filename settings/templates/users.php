...
$(document).ready(function(){
    ...
    $('#newbutton').click(function(){
        $('div.newuser').slideToggle();
    });
    
}) 
</script>
<div id="controls">
    <input id="newbutton" type="submit" value="<?php echo $l->t('New')?>" />
    <div class="quota">
    ...
    <div class="newuser"style="position:fixed; top:6.5em;padding:20px;background-color:#F7F7F7;display:none">
    <form id="newuser">
        <input id="newusername" placeholder="<?php echo $l->t('Name')?>" /><br/>
        <input type="password" id="newuserpassword" placeholder="<?php echo $l->t('Password')?>" /><br/>
